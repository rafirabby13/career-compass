const Subscribe = () => {
  return (
    ...
    lg:px-10 px-1 mb-20 shadow-lg border-2 p-0"
      >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-2">
          <input
            ...
            className="input input-bordered  lg:max-w-xs rounded-none bg-[#fffffffb] placeholder:text-xl placeholder:font-medium text-black outline-none"
          />
