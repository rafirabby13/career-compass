...
const Feature = () => {
  ...
  return (
    <div className=" lg:py-20">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-20 items-center justify-between  ">
        <div className="lg:w-1/2 relative">
          <img src={lady} alt="Career Guidance Icon" />
          <img
            className="hidden lg:flex absolute -bottom-20 -left-20 shadow-2xl rounded-xl  h-60 animate__animated animate__pulse animate__fast animate__delay-3s animate__infinite "
            src={career}
            alt="Career Growth Icon"
          />
          <img
            className=" hidden lg:flex absolute -top-20 -right-10  shadow-2xl rounded-xl   h-60 animate__animated animate__pulse animate__fast animate__delay-3s animate__infinite"
            src={success}
            alt="Success Icon"
          />
        </div>
        <div className="lg:w-1/2 space-y-2 lg:space-y-5">
          <h1 className="text-xl text-center lg:text-start  lg:text-5xl font-semibold">
            <span className="text-[#e77577]">Empower Your Career</span> with
            Expert Guidance
          </h1>
          <p className="text-sm text-center lg:text-start  lg:text-xl">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-5 bg-slate-100 p-2 lg:p-7 rounded-lg">
            <img className="h-24 " src={meeting} alt="" />
            <div>
              <h1
                className="font-bold text-center lg:text-start text-xl mb-1
            "
              >
