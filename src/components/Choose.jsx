  ...
  return (
    <div>
      <div className="text-center py-10 space-y-8">
        <h1 className="text-xl lg:text-4xl font-bold border-b-[3px] lg:border-b-[5px] border-[#c3002f] shadow-md  lg:shadow-2xl p-2 lg:p-8 lg:mb-20 text-center lg:text-start">Why Choose Us</h1>
      ...
      <div className="cards-section grid grid-cols-1   lg:grid-cols-4 gap-6 w-full">
